...
export function QuickAddBar({
  ...
  return (
    <>
      ...
      {/* Panel — uses position absolute inside app container */}
      {/* Sits ABOVE bottom nav, keyboard-aware via padding */}
      <div
        style={{
          position:        "fixed",
          left:            "50%",
          ...
          // Sits above bottom nav (nav ~72px) + small gap
          bottom:          "80px",
          width:           "100%",
          maxWidth:        "430px",
          zIndex:          55,
      ...
      >
        ...
        {voiceLabel && (
          <div
            className="flex items-center justify-center gap-2 mx-4 rounded-card mb-2"
            style={{
              fontSize:        "var(--text-sm)",
              padding:         "8px",
              backgroundColor: "var(--color-bg-card)",
